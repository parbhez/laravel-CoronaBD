<div class="col-lg-6">
                <div class="card mb-4">
                    <div class="card-header">লিঙ্গ সমষ্টি</div>
                    <div class="card-body">
                        <canvas style="display: none;" id="kcuhbdnjfytqmvaprzlexowsg"  height='400' ></canvas>
<div id="kcuhbdnjfytqmvaprzlexowsg_loader" style="
    display: flex;
