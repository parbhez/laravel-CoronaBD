<div class="col-lg-6">
                <div class="card mb-4">
                    <div class="card-header">বয়সের সমষ্টি</div>
                    <div class="card-body">
                        <canvas style="display: none;" id="rcogjhyqaetklsmxnivdfuwpz"  height='400' ></canvas>
<div id="rcogjhyqaetklsmxnivdfuwpz_loader" style="
    display: flex;
